...
export const signUpAction = createAction(UserActionTypes.SIGN_UP, (email, password, navigate, name, lastName) => ({
  payload: { email, password, navigate, name, lastName }
}));

export const signUpSuccessAction = createAction(UserActionTypes.SIGN_UP_SUCCESS, (isAuth, name, lastName) => ({
